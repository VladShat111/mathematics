...
import random
from PG80_Math_program_Data_info import Beginner_jump
#    Easy_jump, Standart_jump, Hardcore_jump, Professional_jump


#print(number01, sign, number02, equals_sign, answer)

Beginner_jump_for_use = Beginner_jump
#Beginner_jump_for_use_item = random.choice(Beginner_jump_for_use)
#print(Beginner_jump_for_use_item)
